                ...
                <div class="mb-2">
                    ...
                    <select name="kabkota_id" id="kabkota_id" class="form-select">
                          ...
                          @foreach ($kabkotas as $kabkota)
                              <option value="{{ $kabkota->id }}" {{ $faskes->kabkota_id == $kabkota->id ? 'selected' : ''}}>{{ $kabkota->name }}</option>
                          @endforeach
                    </select>
                </div>
                <div class="form-group row d-flex justify-content-center">
                ...
                <div class="mb-2">
                    ...
                    <select name="jenis_faskes_id" id="jenis_faskes_id" class="form-select">
                          ...
                          @foreach ($jenis_faskes as $jenis_faskes)
                              <option value="{{ $jenis_faskes->id }}" {{ $faskes->jenis_faskes_id == $jenis_faskes->id ? 'selected' : ''}}>{{ $jenis_faskes->name }}</option>
                          @endforeach
                    </select>
                </div>
                <div class="mb-2">
                    ...
                    <select name="kategori_id" id="kategori_id" class="form-select">
                          ...
                          @foreach ($kategori as $kategori)
                              <option value="{{ $kategori->id }}" {{ $faskes->kategori_id == $kategori->id ? 'selected' : ''}}>{{ $kategori->name }}</option>
                          @endforeach
                    </select>
                </div> 
                <div class="form-group row d-flex justify-content-center">
