    ...
    <div class="row">
        <div class="card">
          <div class="card-body py-3">
            <h2 class="p-3">Tambah Jenis Fasilitas Kesehatan</h2>
            <form action="{{ route('jenis.store') }}" method="POST" class="py-3">
                @csrf
                <div class="form-group row d-flex justify-content-center">
                    <label for="provinsi" class="col-form-label col-8">Jenis Fasilitas Kesehatan</label> 
                    <div class="col-8">
                ...
                <div class="form-group row d-flex justify-content-center">
                    <div class="col-8 d-flex justify-content-center">
                        <a href="{{ route('jenis') }}" class="btn btn-danger btn-rounded me-3">Cancel</a>
