                        ...
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <form method="POST" action="{{ route('register') }} class="signin-form">
                                ...
                                <div class="form-group">
                                    <a href="/masuk" type="submit"
                                        class="form-control btn btn-primary rounded submit px-3">Daftar</a>
                                </div>
                            ...
                            <p class="text-center">Sudah Punya Akun? <a data-toggle="tab" href="/masuk">Masuk</a>
                            </p>
                        </div>
                    </div>
                </div>
